    ...
    switch (action.type) {
        ...
        case C.MOVE_LEFT:
            ...
            if (map[moveY][_move].match(/wall|locked/) === null) {
                ...
                mapSlice[moveY][prevPos] = mapSlice[moveY][prevPos].replace(/player/, '').trimRight();
        ...
        case C.MOVE_DOWN:
            ...
            if (map[_move][moveX].match(/wall|locked|player/) === null) {
                ...
                mapSlice[_move - 1][moveX] = mapSlice[_move - 1][moveX].replace(/player/, '').trimRight();
